...
# Finetune CDLM
python TTS/server/server.py --port 5003  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_CMR_finetune_CDLM/checkpoint_505000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_CMR_finetune_CDLM/config.json
