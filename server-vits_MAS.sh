...
# python TTS/server/server.py  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS__aurora-monoceros-ljspeech_es-es__v1.2/checkpoint_460000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS__aurora-monoceros-ljspeech_es-es__v1.2/config.json

# 48kHz
# python TTS/server/server.py  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS__aurora-monoceros-ljspeech_es-es__v1.2_48khz/checkpoint_230000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS__aurora-monoceros-ljspeech_es-es__v1.2_48khz/config.json
...
# python TTS/server/server.py --port 5003  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_CMR_librivox_10min/best_model_470000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_CMR_librivox_10min/config.json
...
# python TTS/server/server.py --port 5004  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_NAS/checkpoint_405000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_NAS/config.json
...
python TTS/server/server.py --port 5005  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_MAS_finetune_cdlm/best_model_466400.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_MAS_finetune_cdlm/config.json
