...
# python TTS/server/server.py --port 5008 --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_librivox_es_v1.2/checkpoint_330000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_librivox_es_v1.2/config.json
...
# python TTS/server/server.py  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS__CarlosDeLaMorena-RTVE-ljspeech_es-es__v1.2_44.1khz/checkpoint_500000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS__CarlosDeLaMorena-RTVE-ljspeech_es-es__v1.2_44.1khz/config.json
...
python TTS/server/server.py --port 5003  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_v1.2/checkpoint_370000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_v1.2/config.json
...
# python TTS/server/server.py --port 5003  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_finetune_Aurora/checkpoint_655000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_finetune_Aurora/config.json

# Solo noticias
# python TTS/server/server.py --port 5003  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_noticias/checkpoint_155000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_noticias/config.json

# Solo noticias finetune
# python TTS/server/server.py --port 5003  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_noticias_finetune_Aurora/checkpoint_615000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_ABR_noticias_finetune_Aurora/config.json
...
# Fonemas
# python TTS/server/server.py  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS__aurora-monoceros-ljspeech_es-es__v1.2/best_model_243876.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS__aurora-monoceros-ljspeech_es-es__v1.2/config.json
...
# python TTS/server/server.py --port 5005 --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_Aurora_finetune_ABR/checkpoint_700000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_Aurora_finetune_ABR/config.json
