...
## Finetune librivox
# python TTS/server/server.py  --model_path /mnt/DATA/VOCES.AI/MODELS/VITS_CDLM_finetune_librivox/checkpoint_595000.pth.tar --config_path /mnt/DATA/VOCES.AI/MODELS/VITS_CDLM_finetune_librivox/config.json
